...
This software design document (SDD) describes the architecture and system design of the PersonAlytics R package. The `PersonAlytics` package provides analytic tools for single-case, small N, and Idiographic Clinical Trials (ICT) using mixed effect models building the [nlme R package] (https://cran.r-project.org/web/packages/nlme/index.html). It is assumed that the reader

* Has `R` installed on their system and can install the required dependencies
